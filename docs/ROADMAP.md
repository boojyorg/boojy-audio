...
**Working On:** v0.4.0 — Visual & UX polish (foundation + re-treats + top-bar & chrome polish done; **pre-release review complete 2026-06-01 → taggable**; last cleanups: piano-roll lane colours + narrow-window top-bar overflow, then tag)
...
| v0.4.0 | Visual & UX polish (type/palette/scale → re-treats → top-bar) | In progress (taggable) |
| v0.5.0 | Trust & Legibility (correctness/hardening + token/painter legibility) | Planned |
