...
/// Export to WAV file
#[no_mangle]
pub extern "C" fn export_to_wav_ffi(output_path: *const c_char, normalize: bool) -> *mut c_char {
    ffi_catch(
        std::ptr::null_mut(),
        AssertUnwindSafe(|| {
...
pub extern "C" fn is_ffmpeg_available_ffi() -> i32 {
    ffi_catch(-1, || i32::from(api::is_ffmpeg_available()))
}
...
pub extern "C" fn get_tracks_for_stems_ffi() -> *mut c_char {
    ffi_catch(std::ptr::null_mut(), || match api::get_tracks_for_stems() {
