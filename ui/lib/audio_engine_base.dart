...
class _AudioEngineBase {
  ...
  late final _PreviewIsFullyDecodedFfi _previewIsFullyDecoded;
  ...
  _AudioEngineBase() {
    ...
    if (Platform.isMacOS) {
      ...
      for (var i = 0; i < 5; i++) {
        ...
        pathsToTry.add(
          '${searchDir.path}/engine/target/release/libengine.dylib',
        );
    ...
    try {
      ...
      _freeRustString = _lib
          .lookup<ffi.NativeFunction<_FreeRustStringNative>>('free_rust_string')
          .asFunction();
      ...
      _setTempo = _lib
          .lookup<ffi.NativeFunction<_SetTempoFfiNative>>('set_tempo_ffi')
          .asFunction();

      _getTempo = _lib
          .lookup<ffi.NativeFunction<_GetTempoFfiNative>>('get_tempo_ffi')
          .asFunction();
      ...
      // Bind M4 functions
      _createTrack = _lib
          .lookup<ffi.NativeFunction<_CreateTrackFfiNative>>('create_track_ffi')
          .asFunction();
      ...
      _deleteTrack = _lib
          .lookup<ffi.NativeFunction<_DeleteTrackFfiNative>>('delete_track_ffi')
          .asFunction();
      ...
      _saveProject = _lib
          .lookup<ffi.NativeFunction<_SaveProjectFfiNative>>('save_project_ffi')
          .asFunction();

      _loadProject = _lib
          .lookup<ffi.NativeFunction<_LoadProjectFfiNative>>('load_project_ffi')
          .asFunction();
      ...
      _exportAudio = _lib
          .lookup<ffi.NativeFunction<_ExportAudioFfiNative>>('export_audio_ffi')
          .asFunction();
      ...
      _exportStems = _lib
          .lookup<ffi.NativeFunction<_ExportStemsFfiNative>>('export_stems_ffi')
          .asFunction();
      ...
      _previewIsFullyDecoded = _lib
          .lookup<ffi.NativeFunction<_PreviewIsFullyDecodedFfiNative>>(
            'preview_is_fully_decoded_ffi',
          )
          .asFunction();

      _previewPlay = _lib
          .lookup<ffi.NativeFunction<_PreviewPlayFfiNative>>('preview_play_ffi')
          .asFunction();

      _previewStop = _lib
          .lookup<ffi.NativeFunction<_PreviewStopFfiNative>>('preview_stop_ffi')
          .asFunction();

      _previewSeek = _lib
          .lookup<ffi.NativeFunction<_PreviewSeekFfiNative>>('preview_seek_ffi')
          .asFunction();
