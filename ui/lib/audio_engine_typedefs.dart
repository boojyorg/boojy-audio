...
typedef _PlaySineWaveFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Float frequency, ffi.Uint32 durationMs);
typedef _PlaySineWaveFfi =
    ffi.Pointer<Utf8> Function(double frequency, int durationMs);
...
typedef _LoadAudioFileToTrackFfiNative =
    ffi.Int64 Function(ffi.Pointer<ffi.Char>, ffi.Uint64, ffi.Double);
...
typedef _SetRecordStartPositionFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Double);
...
typedef _GetLatencyInfoFfiNative =
    ffi.Void Function(
...
typedef _SetAudioClipWarpFfiNative =
...
typedef _SetAudioClipWarpFfi =
    ffi.Pointer<Utf8> Function(int, int, bool, double, int);

typedef _SetAudioClipTransposeFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Uint64, ffi.Int32, ffi.Int32);
...
typedef _GetWaveformPeaksFfi =
    ffi.Pointer<ffi.Float> Function(int, int, ffi.Pointer<ffi.Size>);

typedef _FreeWaveformPeaksFfiNative =
...
typedef _SetSynthOscillatorTypeFfiNative =
...
typedef _SendMidiNoteOnFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint8, ffi.Uint8);
typedef _SendMidiNoteOnFfi = ffi.Pointer<Utf8> Function(int, int);

typedef _SendMidiNoteOffFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint8, ffi.Uint8);
...
typedef _AddMidiNoteToClipFfiNative =
    ffi.Pointer<Utf8> Function(
      ffi.Uint64,
      ffi.Uint8,
      ffi.Uint8,
...
typedef _AddMidiNoteToClipFfi =
    ffi.Pointer<Utf8> Function(int, int, int, double, double);

typedef _AddMidiClipToTrackFfiNative =
...
typedef _SetTrackInputMonitoringFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Bool);
...
typedef _SetTrackNameFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Pointer<Utf8>);
...
typedef _AddExistingClipToTrackFfiNative =
    ffi.Int64 Function(
      ffi.Uint64,
      ffi.Uint64,
      ffi.Double,
...
typedef _SetEffectParameterFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Pointer<ffi.Char>, ffi.Float);
typedef _SetEffectParameterFfi =
    ffi.Pointer<Utf8> Function(int, ffi.Pointer<ffi.Char>, double);
...
typedef _ReorderTrackEffectsFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Pointer<ffi.Char>);
typedef _ReorderTrackEffectsFfi =
    ffi.Pointer<Utf8> Function(int, ffi.Pointer<ffi.Char>);

// M5 types - Save/Load Project
typedef _SaveProjectFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>);
typedef _SaveProjectFfi =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>);

typedef _LoadProjectFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>);
typedef _LoadProjectFfi = ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>);

typedef _ExportToWavFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>, ffi.Bool);
typedef _ExportToWavFfi =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>, bool);

// M8 types - Enhanced Export
typedef _IsFfmpegAvailableFfiNative = ffi.Int32 Function();
typedef _IsFfmpegAvailableFfi = int Function();

typedef _ExportAudioFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>);
typedef _ExportAudioFfi =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>);

typedef _ExportWavWithOptionsFfiNative =
    ffi.Pointer<Utf8> Function(
...
typedef _ExportWavWithOptionsFfi =
    ffi.Pointer<Utf8> Function(
      ffi.Pointer<ffi.Char>,
      int,
      int,
...
typedef _ExportMp3WithOptionsFfiNative =
    ffi.Pointer<Utf8> Function(
      ffi.Pointer<ffi.Char>,
      ffi.Int32,
      ffi.Uint32,
...
typedef _ExportMp3WithOptionsFfi =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>, int, int, bool, bool);

typedef _WriteMp3MetadataFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>);
typedef _WriteMp3MetadataFfi =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>);

typedef _GetTracksForStemsFfiNative = ffi.Pointer<Utf8> Function();
typedef _GetTracksForStemsFfi = ffi.Pointer<Utf8> Function();

typedef _ExportStemsFfiNative =
    ffi.Pointer<Utf8> Function(
      ffi.Pointer<ffi.Char>,
      ffi.Pointer<ffi.Char>,
      ffi.Pointer<ffi.Char>,
...
typedef _SetTrackInstrumentFfiNative =
    ffi.Int64 Function(ffi.Uint64, ffi.Pointer<ffi.Char>);
...
typedef _SendTrackMidiNoteOnFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Uint8, ffi.Uint8);
typedef _SendTrackMidiNoteOnFfi = ffi.Pointer<Utf8> Function(int, int, int);

typedef _SendTrackMidiNoteOffFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Uint8, ffi.Uint8);
...
typedef _LoadSampleForTrackFfiNative =
...
typedef _SetSamplerParameterFfi =
    ffi.Pointer<Utf8> Function(
      int,
      ffi.Pointer<ffi.Char>,
      ffi.Pointer<ffi.Char>,
...
typedef _GetSamplerInfoFfiNative =
    ffi.Int32 Function(
      ffi.Uint64,
...
typedef _GetSamplerWaveformPeaksFfiNative =
    ffi.Pointer<ffi.Float> Function(
      ffi.Uint64,
      ffi.Size,
      ffi.Pointer<ffi.Size>,
    );
typedef _GetSamplerWaveformPeaksFfi =
    ffi.Pointer<ffi.Float> Function(int, int, ffi.Pointer<ffi.Size>);

typedef _FreeSamplerWaveformPeaksFfiNative =
    ffi.Void Function(ffi.Pointer<ffi.Float>, ffi.Size);
...
typedef _AddVst3EffectToTrackFfiNative =
    ffi.Int64 Function(ffi.Uint64, ffi.Pointer<ffi.Char>);
...
typedef _GetVst3ParameterInfoFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Uint32);
typedef _GetVst3ParameterInfoFfi = ffi.Pointer<Utf8> Function(int, int);

typedef _GetVst3ParameterValueFfiNative =
    ffi.Double Function(ffi.Uint64, ffi.Uint32);
typedef _GetVst3ParameterValueFfi = double Function(int, int);

typedef _SetVst3ParameterValueFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Uint32, ffi.Double);
typedef _SetVst3ParameterValueFfi =
    ffi.Pointer<Utf8> Function(int, int, double);
...
typedef _Vst3AttachEditorFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Pointer<ffi.Void>);
typedef _Vst3AttachEditorFfi =
    ffi.Pointer<Utf8> Function(int, ffi.Pointer<ffi.Void>);

typedef _Vst3SendMidiNoteFfiNative =
    ffi.Pointer<Utf8> Function(
      ffi.Int64,
      ffi.Int32,
      ffi.Int32,
...
typedef _QuantizeMidiClipFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Uint64, ffi.Uint32);
...
typedef _SetAudioOutputDeviceFfi =
    ffi.Pointer<Utf8> Function(ffi.Pointer<Utf8>);
...
typedef _PreviewLoadAudioFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>);
typedef _PreviewLoadAudioFfi =
    ffi.Pointer<Utf8> Function(ffi.Pointer<ffi.Char>);

typedef _PreviewLoadAudioAsyncFfiNative =
...
typedef _SetPunchRegionFfiNative =
    ffi.Pointer<Utf8> Function(ffi.Double, ffi.Double);
