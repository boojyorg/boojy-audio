...
class MidiClipController extends ChangeNotifier {
  ...
  // MIDI clip splitting now lives in the undoable SplitMidiClipCommand (built by
  // DawClipMixin.onMidiClipSplit). The old non-undoable controller copy was
  // removed so there is a single split path. See clip_commands.dart.
